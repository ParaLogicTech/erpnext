...
def get_columns(filters, show_item_name=True):
	...
	columns = [
		...
		{"label": _("In Stock"), "fieldname": "actual_qty", "fieldtype": "Float", "width": 90, "convertible": "qty"},
		{"label": _("Projected Qty"), "fieldname": "projected_qty", "fieldtype": "Float", "width": 90, "convertible": "qty"},
		{"label": _("Ordered (PO)"), "fieldname": "ordered_qty", "fieldtype": "Float", "width": 90, "convertible": "qty"},
		{"label": _("Reserved (SO)"), "fieldname": "reserved_qty", "fieldtype": "Float", "width": 95, "convertible": "qty"},
		{"label": _("Planned (WO)"), "fieldname": "planned_qty", "fieldtype": "Float", "width": 90, "convertible": "qty"},
		{"label": _("Requested (MREQ)"), "fieldname": "indented_qty", "fieldtype": "Float", "width": 120, "convertible": "qty"},
		...
		{"label": _("Reorder Level"), "fieldname": "re_order_level", "fieldtype": "Float", "width": 95, "convertible": "qty"},
		{"label": _("Reorder Qty"), "fieldname": "re_order_qty", "fieldtype": "Float", "width": 90, "convertible": "qty"},
		{"label": _("Shortage Qty"), "fieldname": "shortage_qty", "fieldtype": "Float", "width": 90, "convertible": "qty"},
