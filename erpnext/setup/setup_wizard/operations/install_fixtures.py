...
def install(country=None):
	records = [
		...
		{'doctype': 'Asset Category Group', 'asset_category_group_name': _('All Asset Category Group'), 'is_group': 1, 'name': _('All Asset Category Group'), 'parent_asset_category_group': '', 'lft':1},
